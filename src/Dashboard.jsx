...
export default function Dashboard({ user, onLogout }) {
  ...
  const loadData = useCallback(async () => {
    try {
      const resW = await fetch("http://localhost/backend/api/get_wallets.php", { credentials: "include" });
      const dataW = await resW.json();
      
      const resP = await fetch("http://localhost/backend/api/get_prices.php");
      ...
      const resT = await fetch("http://localhost/backend/api/get_user_trades.php", { credentials: "include" });
      const dataT = await resT.json();
      if (dataT.success) setTrades(dataT.trades);

      const resWith = await fetch("http://localhost/backend/api/get_withdrawals.php", { credentials: "include" });
      const dataWith = await resWith.json();
      if (dataWith.success) setWithdrawals(dataWith.withdrawals);

      const resUser = await fetch("http://localhost/backend/api/get_user_status.php", { credentials: "include" });
  ...
  useEffect(() => {
    ...
    const sync = setInterval(async () => {
      try {
        const response = await fetch("http://localhost/backend/api/check_trades.php", { credentials: "include" });
  ...
  const handleKycUpload = async () => {
    ...
    try {
      const res = await fetch("http://localhost/backend/api/submit_kyc.php", { 
        method: "POST", 
        credentials: "include", 
        body: formData 
      });
  ...
  const loadSwapHistory = async () => {
    try {
      const res = await fetch("http://localhost/backend/api/get_swap_history.php", { credentials: "include" });
      const data = await res.json();
  ...
  const executeConvert = async () => {
    ...
    try {
      const res = await fetch("http://localhost/backend/api/convert.php", { 
        method: "POST", 
        credentials: "include", 
  ...
  const executeTrade = async (direction) => {
    ...
    try {
      ...
      const res = await fetch("http://localhost/backend/api/trade.php", { 
        method: "POST", 
        credentials: "include", 
        headers: { "Content-Type": "application/json" }, 
  ...
  const fetchChatHistory = async () => {
    try {
      const res = await fetch("http://localhost/backend/api/get_support_messages.php", { credentials: "include" });
      const data = await res.json();
  ...
  const sendSupportMessage = async () => {
    ...
    try {
      const res = await fetch("http://localhost/backend/api/send_support_message.php", { method: "POST", credentials: "include", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ message: supportMessage }), });
      const data = await res.json();
  ...
  const logout = async () => {
    await fetch("http://localhost/backend/api/logout.php", { credentials: "include" });
    onLogout();
  };
